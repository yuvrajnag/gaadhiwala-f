...
const Home = () => {
    ...
    const handleSignIn = async (e) => {
        ...
        try {
            // Mock backend response for frontend-only mode
            const mockUser = {
                email: formData.email,
                role: 'customer', // Default to customer, can be adjusted
                name: 'Test User'
            };
    ...
    useEffect(() => {
        if (!localStorage.getItem('zoomTipShown')) {
            setShowZoomTip(true);
        }
        ...
        <div className="home-container">
            ...
            {showZoomTip && (
                <div style={{
                    ...
                    <span style={{ fontSize: '0.95rem' }}>For the best experience, please zoom out your browser to 75%. (We are working on responsiveness!)</span>
                    <button 
                        onClick={() => {
